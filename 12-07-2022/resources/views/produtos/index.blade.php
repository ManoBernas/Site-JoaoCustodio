      ...
      <table class="table align-items-center mb-0">
        <thead>
          <tr>
            ...
            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Preço Base</th>
            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Disponibilidade do Produto</th>
        ...
        <tr>
            <td>
              <div class="d-flex px-2 py-1">
                <div class="d-flex flex-column justify-content-center">
                  ...
                  <p class="text-xs text-secondary mb-0"><a href="/produtos/{{ $produto->id }}/edit">{{ $produto->categoria->designacao }}</a></p>
                </div>
              </div>
            </td>
            <td>
            ...
            <td class="text-center"><i class="fa fa-trash text-xs font-weight-bold mb-0 text-danger" aria-hidden="true"></i></td>
          </tr>
