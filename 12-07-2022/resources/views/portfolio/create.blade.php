...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-1">
            <div class="col-sm-6">
                <h3>Produtos Portfolio</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                    <li class="breadcrumb-item active">Novo Produto Porfolio</li>
                </ol>
            </div>
        </div>
    </div>
</section>
<form role="form" method="POST" action="/portfolio" enctype="multipart/form-data">
@csrf
    <div class="card-body">
